...
public class ContractorChallanController {
    ...
    public ResponseEntity<ApiResponseVo<List<ContractorChallanVo>>> find(
        ...
        log.info("Received request for find :: challanNumber {}, contractorId {}, fromDate {}, toDate {}, challanType {}",
                challanNumber, contractorId, fromDate, toDate, challanType);
        ...
        List<ContractorChallanVo> found = service.findAll(challanNumber, contractorId, fromDate, toDate, challanType);
