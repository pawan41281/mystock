...
public interface ContractorRepository extends JpaRepository<ContractorEntity, Long>{
	...
	List<ContractorEntity> findByContractorNameContainingIgnoreCase(String ContractorName);

	List<ContractorEntity> findByCityContainingIgnoreCase(String city);

	List<ContractorEntity> findByStateContainingIgnoreCase(String state);

	List<ContractorEntity> findByCountryIgnoreCase(String country);

	List<ContractorEntity> findByEmailIgnoreCase(String email);

	List<ContractorEntity> findByMobile(String mobile);

	List<ContractorEntity> findByGstNoContainingIgnoreCase(String gstNo);

	List<ContractorEntity> findByActive(boolean active);
